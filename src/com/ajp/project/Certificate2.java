		...
		try {
			...
			ResultSet rs =  st.executeQuery(query);
			 ...
			 if(dose.equals("Dose1")){
				 ...
				 res.getWriter().println("<div class=reason>Together, India will defeat COVID-19</div>");
				 ...
				 String query1 = "SELECT * FROM user_details WHERE MobileNo = '"+mob+"' and Password = '"+password+"';";
